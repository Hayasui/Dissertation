...
custom_labels_base <- c(
  ...
  "price_usd_categoryMid-tier" = "Price (USD): Mid-tier ($10.01 - $30)",
  ...
  "price_cny_categoryMid-tier" = "Price (CNY): Mid-tier (¥50.01 - ¥120)",
  "price_cny_categoryMajor Release" = "Price (CNY): Major Release (¥120.01 - ¥200)",
  "price_cny_categoryPremium AAA" = "Price (CNY): Premium AAA (> ¥200)"
)
...
interaction_labels <- c(
  ...
  "full_localisation_comboAudio + Text:price_usd_categoryMid-tier" = "Localisation (Audio+Text) x Price (Mid-tier)",
  ...
  "full_localisation_comboNone:price_usd_categoryMid-tier" = "No Localisation x Price (Mid-tier)",
  ...
  "full_localisation_comboAudio + Text:price_cny_categoryMid-tier" = "Localisation (Audio+Text) x Price (Mid-tier)",
  ...
  "full_localisation_comboNone:price_cny_categoryMid-tier" = "No Localisation x Price (Mid-tier)",
...
tab_model(model1, 
          ...
          pred.labels = custom_labels_all,  # Use filtered labels
          show.reflvl = FALSE, 
          p.style = "numeric",
          collapse.ci = TRUE, 
          show.r2 = TRUE, 
